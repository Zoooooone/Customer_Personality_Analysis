...
for i in range(len(y)):
    pre, rec, acc, f1 = cross_validation(RandomForestClassifier(n_estimators=1000, random_state=42), X, y[i])
    res["model"].append("random forest")
...
res.to_csv("results/classification_res.csv")
